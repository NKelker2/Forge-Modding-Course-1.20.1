package net.illNameLater.mccourse.item;

import net.illNameLater.mccourse.MCCourseMod;
import net.illNameLater.mccourse.block.ModBlocks;
...
public class ModCreativeModeTabs {
    ...
    public static final RegistryObject<CreativeModeTab> COURSE_TAB = CREATIVE_MODE_TABS.register("course_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.ALEXANDRITE.get())).title(Component.translatable("creativetab.course_tab"))
